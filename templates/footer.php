                    ...
                    <div class="col-md-5 p-5 sec-footer">
                        ...
                        <ul class="text-white list-unstyled">
                            ...
                            <ul class="nav me-auto" style="border: none;">
                                <li class="nav-item"><a href="https://wa.link/8k0flz" class="nav-link link-body-emphasis px-2 text-white" data-bs-trigger="hover focus"><i class="fab fa-whatsapp" aria-hidden="true"></i></a></li>
                                <li class="nav-item"><a href="#" class="nav-link link-body-emphasis px-2 text-white" data-bs-trigger="hover focus"><i class="fab fa-facebook-f" aria-hidden="true"></i></a></li>
                                <li class="nav-item"><a href="#" class="nav-link link-body-emphasis px-2 text-white" data-bs-trigger="hover focus"><i class="fab fa-instagram" aria-hidden="true"></i></a></li>
                                <li class="nav-item"><a href="#" class="nav-link link-body-emphasis px-2 text-white" data-bs-trigger="hover focus"><i class="fab fa-tiktok" aria-hidden="true"></i></a></li>
                                <li class="nav-item"><a href="mailto:info@sanjosechakan.com" class="nav-link link-body-emphasis px-2 text-white" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-trigger="hover focus" data-bs-content="info@sanjosechakan.com"><i class="fas fa-envelope" aria-hidden="true"></i></a></li>
                            </ul>
                        </ul>
                    </div>
                </div>

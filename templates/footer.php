                    ...
                    <div class="col-md-5 p-5 sec-footer">
                        ...
                        <ul class="text-white list-unstyled">
                            ...
                            <ul class="nav me-auto" style="border: none;">
                                <li class="nav-item"><a href="https://wa.link/8k0flz" target="_blank" class="nav-link link-body-emphasis px-2 text-white" data-bs-trigger="hover focus"><i class="fab fa-whatsapp" aria-hidden="true"></i></a></li>
                                <li class="nav-item"><a href="https://www.facebook.com/people/Royal-County-San-Jos%C3%A9-Chak%C3%A1n/61555830144863/?mibextid=LQQJ4d" target="_blank" class="nav-link link-body-emphasis px-2 text-white" data-bs-trigger="hover focus"><i class="fab fa-facebook-f" aria-hidden="true"></i></a></li>
                                <li class="nav-item"><a href="https://www.instagram.com/rcountysanjosechakan?igsh=MTI1a2NycDdma2QyYg%3D%3D&utm_source=qr" target="_blank" class="nav-link link-body-emphasis px-2 text-white" data-bs-trigger="hover focus"><i class="fab fa-instagram" aria-hidden="true"></i></a></li>
                                <li class="nav-item"><a href="https://www.tiktok.com/@royalcountysanjosechakan?_t=8l3deamL92E&_r=1" target="_blank" class="nav-link link-body-emphasis px-2 text-white" data-bs-trigger="hover focus"><i class="fab fa-tiktok" aria-hidden="true"></i></a></li>

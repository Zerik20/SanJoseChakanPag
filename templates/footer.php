                ...
                <div class="row w-100 p-0 m-0">
                    <div class="col-md-3 p-5 sec-footer">
                        ...
                        <ul class="text-white list-unstyled" style="text-align: center;">
                            ...
                            <a class="text-white text-decoration-none" href="emociones.php"><li class="mb-2 link-footer"><p id="optfooter9" data-section="Footer" data-value="EmoFoot" style="text-align: center; border-bottom: 1px solid white;">Emotions</p></li></a>

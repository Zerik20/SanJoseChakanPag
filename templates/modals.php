  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content p-4">
      <div class="modal-header">
        <h1 class="modal-title fs-5 text-center w-100" id="exampleModalToggleLabel">INGRESA TU CONTRASEÑA</h1>
      </div>
      <div class="modal-body text-center">
        <img id="logo" class="text-center w-50 my-2" src="img/logo.png" alt="logo-RCC"><br>
        <p id="txtmod1" class="text-center fw-bold my-4">Ingrese la contraseña que le fue proporcionada.</p>
        ...
        <a href="https://wa.link/ju6n9w" target="_blank"><p id="olvcontra" class="my-2 text-center text-black m-0 p-p">Olvidé mi contraseña</p></a>
        <a href="https://wa.link/pf0lw7" target="_blank"><p id="nocontra" class="my-2 text-center text-black m-0 p-p">Aun no tengo una contraseña</p></a>
      </div>
      <div class="modal-footer d-flex justify-content-center">
        <button id="verificarContrasenaBtn" class="boton text-center">Iniciar sesión</button>
      </div>
    </div>
  </div>
</div>

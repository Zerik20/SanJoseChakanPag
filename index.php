...
<div class="cont1-acerca-de sombra">
    <div class="row w-100 m-0 p-0 d-flex">
        ...
        <div class="col-md-3 p-0 m-0 cont-list1" style="background: black;">
            <div class="d-flex align-items-center h-100 p-3">
                <div>
                    ...
                    <ul class="mb-5" data-aos="fade-up">
                        ...
                        <li class="newlis1 d-flex mb-3"><span>7</span><p id="btnlist1hotel7" class="m-0 mt-1 txt-list1 fw-bold text-start text-white"data-section="MasterPlan" data-value="Market">Market Place</p></li>
                        <li class="newlis1 d-flex mb-3"><span>8</span><p id="btnlist1hotel8" class="m-0 mt-1 txt-list1 fw-bold text-start text-white"data-section="MasterPlan" data-value="Estudios">Estudio</p></li>
                        <li class="newlis1 d-flex mb-3"><span>9</span><p id="btnlist1hotel9" class="m-0 mt-1 txt-list1 fw-bold text-start text-white" data-section="MasterPlan" data-value="Glamping">Glamping</p></li>
                        <li class="newlis1 d-flex mb-3"><span>10</span><p id="btnlist1hotel10" class="m-0 mt-1 txt-list1 fw-bold text-start text-white" data-section= "MasterPlan" data-value= "ColSui">Colegio Suizo</p></li>
                        <li class="newlis1 d-flex mb-3"><span>11</span><p id="btnlist1hotel11" class="m-0 mt-1 txt-list1 fw-bold text-start text-white" data-section= "MasterPlan" data-value= "MayaKi">Maya Kingdom</p></li>
                        <li class="newlis1 d-flex mb-3"><span>12</span><p id="btnlist1hotel12" class="m-0 mt-1 txt-list1 fw-bold text-start text-white" data-section= "MasterPlan" data-value= "PetPa">Pet Park</p></li>
                    </ul>
                    <!--div class="nav flex-column nav-pills mb-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <button class="nav-link link-img active d-flex" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true"><span>+</span><p id="btnlist1mp" class="m-0 txt-list1"> <b>Master Plan</b>.</button></p>
                        <button class="nav-link link-img d-flex" id="v-pills-golf-tab" data-bs-toggle="pill" data-bs-target="#v-pills-golf" type="button" role="tab" aria-controls="v-pills-golf" aria-selected="true"><span>1</span><p id="btnlist1campogolf" class="m-0 txt-list1"> Campo de golf de 9 hoyos.</button></p>
                        <button class="nav-link link-img d-flex" id="v-pills-profile2-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile2" type="button" role="tab" aria-controls="v-pills-profile2" aria-selected="false"><span>2</span><p id="btnlist1club" class="m-0 txt-list1"> Casa club.</button></p>
                        <button class="nav-link link-img d-flex" id="v-pills-disabled-tab" data-bs-toggle="pill" data-bs-target="#v-pills-disabled" type="button" role="tab" aria-controls="v-pills-disabled" aria-selected="false"><span>3</span><p id="btnlist1hotel" class="m-0 txt-list1"> Zona hotelera.</button></p>
                        <button class="nav-link link-img d-flex" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false"><span>4</span><p id="btnlist1comer" class="m-0 txt-list1"> Zona comercial.</button></p>
                        <button class="nav-link link-img d-flex" id="v-pills-settings-tab" data-bs-toggle="pill" data-bs-target="#v-pills-settings" type="button" role="tab" aria-controls="v-pills-settings" aria-selected="false"><span>5</span><p id="btnlist1colegio" class="m-0 txt-list1"> Colegio.</button></p>
                        <button class="nav-link link-img d-flex" id="v-pills-settings-2-tab" data-bs-toggle="pill" data-bs-target="#v-pills-settings-2" type="button" role="tab" aria-controls="v-pills-settings-2" aria-selected="false"><span>6</span><p id="btnlist1glamping" class="m-0 txt-list1"> Glamping (con cenotes).</button></p>
                    </div-->
...
-->
        ...
        <div class="col-md-4 m-0 p-2" data-aos="zoom-in">
            <a class="example-image-link" href="img/pp.jpg" data-lightbox="example-2" data-title="">
...
<div class="">
    <div class="row d-flex align-items-start bg-black m-0">
        <div class="col-md-5 p-4 cont-btn-list2">
            <h2 id="titacc" class="text-white tit ame-club"  data-aos="fade-up">Amenidades de la casa club</h2>
            <p id="txtacc" class="text-white txt-amenidades"  data-aos="fade-up">Bienvenido, aquí encontrarás las mas lujosas instalaciones para disfrutar de tu tiempo libre y relajarte en un entorno excepcional. </p>
            <div class="nav row nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="horizontal">
                <div class="col-md-9 cont-lista2"  data-aos="fade-up">
                    <button class="nav-link active text-start list-club-op w-100 d-flex" id="v-pills-1-tab" data-bs-toggle="pill" data-bs-target="#v-pills-1" type="button" role="tab" aria-controls="v-pills-1" aria-selected="true"><i class="fas fa-chevron-circle-right mt-1 me-1" aria-hidden="true"></i><p id="list1acc" class="m-0 text-start"> Campo de Golf</p></button>
                    <button class="nav-link text-start list-club-op w-100 d-flex" id="v-pills-2-tab" data-bs-toggle="pill" data-bs-target="#v-pills-2" type="button" role="tab" aria-controls="v-pills-2" aria-selected="false"><i class="fas fa-chevron-circle-right mt-1 me-1" aria-hidden="true"></i><p id="list2acc" class="m-0 text-start"> Hoyo 10</p></button>
                    <button class="nav-link text-start list-club-op w-100 d-flex" id="v-pills-3-tab" data-bs-toggle="pill" data-bs-target="#v-pills-3" type="button" role="tab" aria-controls="v-pills-3" aria-selected="false"><i class="fas fa-chevron-circle-right mt-1 me-1" aria-hidden="true"></i><p id="list3acc" class="m-0 text-start"> Restaurante</p></button>
                    <!--
...
-->
                    <button class="nav-link text-start list-club-op w-100 d-flex" id="v-pills-6-tab" data-bs-toggle="pill" data-bs-target="#v-pills-6" type="button" role="tab" aria-controls="v-pills-6" aria-selected="false"><i class="fas fa-chevron-circle-right mt-1 me-1" aria-hidden="true"></i><p id="list6acc" class="m-0 text-start"> Gimnasio</p></button>
                    <button class="nav-link text-start list-club-op w-100 d-flex" id="v-pills-7-tab" data-bs-toggle="pill" data-bs-target="#v-pills-7" type="button" role="tab" aria-controls="v-pills-7" aria-selected="false"><i class="fas fa-chevron-circle-right mt-1 me-1" aria-hidden="true"></i><p id="list7acc" class="m-0 text-start"> Sala de Juegos</p></button>
                    <button class="nav-link text-start list-club-op w-100 d-flex" id="v-pills-8-tab" data-bs-toggle="pill" data-bs-target="#v-pills-8" type="button" role="tab" aria-controls="v-pills-8" aria-selected="false"><i class="fas fa-chevron-circle-right mt-1 me-1" aria-hidden="true"></i><p id="list8acc" class="m-0 text-start"> Piscina</p></button>
                    <!--
...
-->
                    <!--button class="nav-link text-start list-club-op w-100 d-flex p-2 align-items-center" id="v-pills-10-tab" data-bs-toggle="pill" data-bs-target="#v-pills-10" type="button" role="tab" aria-controls="v-pills-10" aria-selected="false"><i class="fas fa-chevron-circle-right" aria-hidden="true"></i> <p id="list10accm" class="m-0 text-start"> Campo de practica</p></!--button>
                    <button class="nav-link text-start list-club-op w-100 d-flex p-2 align-items-center" id="v-pills-11-tab" data-bs-toggle="pill" data-bs-target="#v-pills-11" type="button" role="tab" aria-controls="v-pills-11" aria-selected="false"><i class="fas fa-chevron-circle-right" aria-hidden="true"></i> <p id="list11accm" class="m-0 text-start"> Área de baños</p></button>
                    <button-- class="nav-link text-start list-club-op w-100 d-flex p-2 align-items-center" id="v-pills-12-tab" data-bs-toggle="pill" data-bs-target="#v-pills-12" type="button" role="tab" aria-controls="v-pills-12" aria-selected="false"><i class="fas fa-chevron-circle-right" aria-hidden="true"></i> <p id="list12accm" class="m-0 text-start"> Pro Shop Golf</p></button-->
                </div>
        ...
        <div class="col-md-7 p-0">
            <div class="tab-content" id="v-pills-tabContent" style="height: 750px;">
                ...
                <!--div class="tab-pane h-100 fade" id="v-pills-10" role="tabpanel" aria-labelledby="v-pills-10-tab" tabindex="0">
                    <div class="w-100 h-100" style="background-image: url('img/practicagolf.webp') !important; background-size: cover; background-position: center;">

                    </div>
                </!--div>
                <div class="tab-pane h-100 fade" id="v-pills-11" role="tabpanel" aria-labelledby="v-pills-11-tab" tabindex="0">
                    <div class="w-100 h-100" style="background-image: url('img/zdm.JPG') !important; background-size: cover; background-position: center;">

                    </div>
                </div>
                <div-- class="tab-pane h-100 fade" id="v-pills-12" role="tabpanel" aria-labelledby="v-pills-12-tab" tabindex="0">
                    <div class="w-100 h-100" style="background-image: url('img/proshop.jpeg') !important; background-size: cover; background-position: center;">
...
<div class="sect-texto-index" style="  background-image: url(img/bgl.webp); background-size: cover;"> 
    <div class="overlay-sect-txt-index p-5 w-100 h-100">
        <div class="container py-5 text-center">
            <h4 id="txtvm1" class="text-center mb-4 mt-0" data-aos="fade-up">Royal County San José Chakan, una comunidad única y exclusiva, nutrida por un
            profundo compromiso ecológico y el deseo de vivir de manera sostenible y 
            en plenitud.</h4>
            <a id="btnlist2" data-aos="fade-up" href="productos.php" class="boton">Ver Más <i class="fas fa-arrow-right"></i></a>
        </div>

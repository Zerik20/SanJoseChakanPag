    ...
    <div class="tab-pane fade" id="v-pills-newsec2" role="tabpanel" aria-labelledby="v-pills-newsec2-tab" tabindex="0">
      ...
      <div class="w-100">
        ...
        <div class="w-100">
          ...
          <div class="movil">
            <div class="text-center">
              <a href="documentos/FichaTecnica_RC.pdf" class="boton aos-init aos-animate mx-2" target="_blank"><i class="fas fa-eye"></i><span id="btninm5">Ver Ficha técnica</span> </a>
              <a href="documentos/FichaTecnica_RC.pdf"  download="FichaTecnica_RC.pdf" class="boton aos-init aos-animate mx-2" target="_blank"><i class="fas fa-download" aria-hidden="true"></i> <span id="btninm6">Descaragar Ficha técnica</span> </a>
            </div>
          </div>
        </div>

...
<div class="w-100">
        ...
        <h1 id="titinm7" class="tit text-center" style="color: brown;">disponibilidad3</h1>
        ...
        <div class="w-100">
          ...
          <iframe id="pdfViewer2" src="documentos/ListaDePrecios.pdf" width="100%" height="100%"></iframe>
        </div>

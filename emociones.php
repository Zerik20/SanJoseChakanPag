...
<script src="idiomas/lengemo.js"></script>
    ...
    <div class="row w-100 m-0 p-0 d-flex">
        <div class="col-md-6 row acerca-img">
            <div class="col-md-6 p-2">
                <div class="image-acerca" style="background-image: url('img/pg.jpg') !important; margin-top: -20px;"></div>
            </div>
            <div class="col-md-6 p-2">
                <div class="image-acerca" style="background-image: url('img/pb.jpg') !important; margin-top: 20px;"></div>
            </div>
        </div>
    ...
    <div class="row w-100 m-0 p-0 d-flex">
        ...
        <div class="col-md-6 row acerca-img">
            <div class="col-md-8 p-2">
                <div class="image-acerca" style="background-image: url('img/abeja.jpg') !important; "></div>
            </div>
            <div class="col-md-12">
                <div class="image-acerca" style="background-image: url('img/niñoss.jpg') !important; margin-right: -52px; margin-left: 98px; margin-top: -94px;"></div>
            </div>
...
<div class="container">
    <div class="row w-100 m-0 p-0 d-flex">
        <div class="col-md-7 row acerca-img">
            <div class="col-md-6 p-2">
                <div class="image-acerca" style="background-image: url('img/pastel.jpg') !important; margin-top: -20px;"></div>
            </div>
            <div class="col-md-6 p-2">
                <div class="image-acerca" style="background-image: url('img/piñata.jpg') !important; margin-top: 20px;"></div>
            </div>
        </div>
    ...
    <div class="row w-100 m-0 p-0 d-flex">
        ...
        <div class="col-md-6 row acerca-img d-flex justify-content-end">
            <div class="col-md-12 p-3">
                <div class="image-acerca" style="background-image: url('img/fam1.jpg') !important; margin-top: -20px;"></div>
            </div>
            <div class="col-md-12 p-3" style="margin-right: -25px;">
                <div class="image-acerca" style="background-image: url('img/fam2.jpg') !important; margin-top: -20px;"></div>
            </div>
        </div>
